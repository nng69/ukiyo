...
## Copia già pronta nel progetto

Nel repository esiste anche `Desktop/ODDIO/index.html`: è una copia esplicita pensata per essere trovata subito quando apri i file del progetto. Se invece vuoi l'icona sul Desktop reale del tuo computer, devi eseguire lo script di installazione dalla cartella principale.
